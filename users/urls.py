...
urlpatterns = [
    ...
    path('api/friends/', FriendshipListView.as_view(), name='friend_list_api'),
    path('api/friend-requests/', FriendRequestListView.as_view(), name='friend_request_list_api'),
    path('api/send-friend-request/<int:to_user_id>/', SendFriendRequestView.as_view(), name='send_friend_request_api'),
    path('api/accept-friend-request/<int:from_user_id>/', AcceptFriendRequestView.as_view(), name='accept_friend_request_api'),
    path('api/remove-friend/<int:friend_id>/', RemoveFriendView.as_view(), name='remove_friend_api'),
]
